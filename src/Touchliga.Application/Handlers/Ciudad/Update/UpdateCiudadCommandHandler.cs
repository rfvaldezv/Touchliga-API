...
namespace Touchliga.Application.Handlers.Ciudad.Update;

public sealed class UpdateCiudadCommandHandler : IRequestHandler<UpdateCiudadCommand, long>
{
    private readonly ICiudadRepository _repository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUserService _currentUser;

    public UpdateCiudadCommandHandler(
